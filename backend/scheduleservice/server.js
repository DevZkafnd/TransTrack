...
app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(swaggerSpec, {
  ...
  customSiteTitle: 'Dokumentasi API ScheduleService'
}));
...
app.get('/', (req, res) => {
  res.json({
    pesan: 'ScheduleService API - TransTrack Microservice',
    message: 'API untuk mengelola data jadwal perjalanan bus',
    version: '1.0.0',
...
// Start server
app.listen(PORT, () => {
  console.log(`ScheduleService berjalan pada port ${PORT}`);
