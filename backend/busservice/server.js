...
app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(swaggerSpec, {
  ...
  customSiteTitle: 'Dokumentasi API BusService'
}));
...
app.get('/', (req, res) => {
  res.json({
    pesan: 'BusService API - TransTrack Microservice',
    message: 'API untuk mengelola data master armada bus',
    version: '1.0.0',
...
// Start server
app.listen(PORT, () => {
  console.log(`BusService berjalan pada port ${PORT}`);
